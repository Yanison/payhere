...
완성도를 높이지 못한게 많이 아쉬움이 남습니다. 이번 프로젝트에서 Front-End 개발의 방향성은 jQuery로부터 <br>
멀어지고자 하는것이였습니다. jQuery는 간결한 코드로 Dom 객체를 쉽게 다룰 수 있는 강력한 JS라이브러리 <br>
이지만 쉽게 사용할 수 있는 만큼 JS를 이해하는데에 방해된다고 생각합니다. 그래서 Vanila JS만을 사용하여<br>
(서버쪽 요청은 Ajax 이지만..) 직접적인 Dom 객체들을 컨트롤 하여 UI를 구성하는 것이 이번 Front-Side의<br>
목표였습니다. 성능 이슈같은 주제까지 갈 만큼 수준높은 코드는 아니지만 목적에 맞게 순수 JS로만 프로젝트를 <br>
...
이상입니다.<br>
저의 부족한 과제를 시간내어 살펴봐주셔서 감사합니다.<br>
